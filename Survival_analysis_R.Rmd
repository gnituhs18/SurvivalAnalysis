...
gene_scores <- read_tsv("/Users/UCD/Research/Cancer/SurvivalCurves/data/all_thresholded.by_genes.txt") |> 
  t() |> 
  as.data.frame()
...
clinical_data <- read_csv(
  "/Users/UCD/Research/Cancer/SurvivalCurves/data/clinical2.csv",
)|>
  select(
      barcode,
      vital_status,
...
phen <- read_csv("/Users/UCD/Research/Cancer/SurvivalCurves/data/dataandphen.csv") |> 
